...
func (x *CreateUserRespose) Reset() {
	*x = CreateUserRespose{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateUserRespose) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateUserRespose) ProtoMessage() {}

func (x *CreateUserRespose) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_create_user_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateUserRespose.ProtoReflect.Descriptor instead.
func (*CreateUserRespose) Descriptor() ([]byte, []int) {
	return file_rpc_create_user_proto_rawDescGZIP(), []int{1}
}

func (x *CreateUserRespose) GetUser() *User {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *CreateUserRespose) GetAccount() *Account {
	if x != nil {
		return x.Account
	}
	return nil
...
var file_rpc_create_user_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0d, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9a, 0x01, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	,
...
var file_rpc_create_user_proto_goTypes = []any{
	...
	(*CreateUserRespose)(nil), // 1: pb.CreateUserRespose
	(*User)(nil),              // 2: pb.User
	(*Account)(nil),           // 3: pb.Account
}
var file_rpc_create_user_proto_depIdxs = []int32{
	2, // 0: pb.CreateUserRespose.user:type_name -> pb.User
	3, // 1: pb.CreateUserRespose.account:type_name -> pb.Account
...
func file_rpc_create_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_create_user_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*CreateUserRespose); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
